...
public class ImportController {
    ...
    @RequestMapping("/importBusinessTrip.do")
    public ModelAndView importBusinessTrip(HttpServletRequest request, HttpServletResponse response) throws IllegalStateException, IOException {
        Map<String,Object> map = new HashMap<String,Object>();
        List<String> filelist = new ArrayList<String>();
        try {
            String tab = request.getParameter("tab");
            ...
            for (String path:filelist){
                // 第二步，添加文件到数据库，会返回成功的数量和失败的列表
                Map<String, Object> map2 = importService.insertBusinessTrip(path);
                map.putAll(map2);
                // 第三步，把刚才创建的excel文件删除掉
                File fileDelete = new File(path);
                fileDelete.delete();
        ...
        return new ModelAndView("/upload-chuchai",map);
    }

    @RequestMapping("/importOvertime.do")
    public ModelAndView importOvertime(HttpServletRequest request, HttpServletResponse response) throws IllegalStateException, IOException {
        Map<String,Object> map = new HashMap<String,Object>();
        List<String> filelist = new ArrayList<String>();
        try {
            String tab = request.getParameter("tab");
            ...
            for (String path:filelist){
                // 第二步，添加文件到数据库，会返回成功的数量和失败的列表
                Map<String, Object> map2 = importService.insertYoOvertime(path);
                map.putAll(map2);
                // 第三步，把刚才创建的excel文件删除掉
                File fileDelete = new File(path);
                fileDelete.delete();
        ...
        return new ModelAndView("/upload-jiaban",map);
    }

    @RequestMapping("/importSubway.do")
    public ModelAndView importSubway(HttpServletRequest request, HttpServletResponse response) throws IllegalStateException, IOException {
        Map<String,Object> map = new HashMap<String,Object>();
        List<String> filelist = new ArrayList<String>();
        try {
            String tab = request.getParameter("tab");
            ...
            for (String path:filelist){
                // 第二步，添加文件到数据库，会返回成功的数量和失败的列表
                Map<String, Object> map2 = importService.insertSubway(path);
                map.putAll(map2);
                // 第三步，把刚才创建的excel文件删除掉
                File fileDelete = new File(path);
                fileDelete.delete();
        ...
        return new ModelAndView("/upload-jiaotong",map);
    }

    @RequestMapping("/importItemChange.do")
    public ModelAndView importItemChange(HttpServletRequest request, HttpServletResponse response) throws IllegalStateException, IOException {
        Map<String,Object> map = new HashMap<String,Object>();
        List<String> filelist = new ArrayList<String>();
        try {
            String tab = request.getParameter("tab");
            ...
            for (String path:filelist){
                // 第二步，添加文件到数据库，会返回成功的数量和失败的列表
                Map<String, Object> map2 = importService.insertYoItemChange(path);
                map.putAll(map2);
                // 第三步，把刚才创建的excel文件删除掉
                File fileDelete = new File(path);
                fileDelete.delete();
        ...
        return new ModelAndView("/upload-project",map);
    }

    @RequestMapping("/importYindaIdentify.do")
    public ModelAndView importYindaIdentify(HttpServletRequest request, HttpServletResponse response) throws IllegalStateException, IOException {
        Map<String,Object> map = new HashMap<String,Object>();
        List<String> filelist = new ArrayList<String>();
        try {
            String tab = request.getParameter("tab");
            ...
            for (String path:filelist){
                // 第二步，添加文件到数据库，会返回成功的数量和失败的列表
                Map<String, Object> map2 = importService.insertYoYindaIdentify(path);
                map.putAll(map2);
                // 第三步，把刚才创建的excel文件删除掉
                File fileDelete = new File(path);
                fileDelete.delete();
